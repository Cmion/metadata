...
const ct = require('./model/countries/countries.json');
const fs = require('fs')
const path = require('path')

// const states = ct.map(c => {
//     const states = (CountriesState.find(o => o.iso2 === c.iso2)?.states ?? []).map((s, i) => {
//         return {name: s.name, state_code: s.state_code}
//     });

//     return Object.assign({}, c, {states})
// })

// fs.writeFileSync(path.resolve(__dirname, 'model', 'states', 'states.json'), JSON.stringify(states), err => {
//     if(err) {
//         console.log(err)
//         return;
//     }
...
// const tz = timezones.map(zone => ({
//     ...zone, 
//     id: zone.abbr?.toLowerCase()
// }))

// fs.writeFileSync(path.resolve(__dirname, 'model', 'timezones', 'timezones.json'), JSON.stringify(tz), err => {
//     if(err) {
//         console.log(err)
//         return;
//     }
...
//   const nCt = ct.map(c => {
//       const a = nt[c.iso2]
//       return Object.assign({}, c, {native_name: a.native, languages: a.languages})
//   })

//   fs.writeFileSync(path.resolve(__dirname, 'model', 'countries', 'countries.json'), JSON.stringify(nCt), err => {
//     if(err) {
//         console.log(err)
//         return;
//     }
...
// const languages = Object.keys(lang).map(l => {
//     return {
//         name: lang[l].name,
//         native_name: lang[l].native,
//         id: l,
//         code: l
//     }
// })
...
//   fs.writeFileSync(path.resolve(__dirname, 'model', 'languages', 'languages.json'), JSON.stringify(languages), err => {
//     if(err) {
//         console.log(err)
//         return;
//     }
...
const currency = [
  ...
  fs.writeFileSync(path.resolve(__dirname, 'model', 'currencies', 'currencies.json'), JSON.stringify(currency.map(c => ({...c, id: c.code.toLowerCase()}))), err => {
    if(err) {
        console.log(err)
        return;
    }
